...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate adversarial questions from CaseGraph JSON files.")
...
def main() -> None:
    ...
    for path in graph_paths(Path(args.input)):
        ...
        for policy_name in selected_policy_names:
            ...
            attacks.append(attacker.generate(graph, route).to_dict())
