...
- `ATTACKER_MODE=coverage`: deterministic high-coverage probes for evaluation memory building. This mode forces `add` during construction so generic probe wording cannot collapse unrelated facts through BM25 merge decisions.
